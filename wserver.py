...
<link rel='icon' href='/logo/gmd.png'>
...
<title>Gabrier Drive | About Creator</title>
<style type="text/css">
body {
min-height: 100%;
background-image: url('/background/wpback.jpg');
color: white;
}
.main {
...
<body>
<div class="main">
<div class="title" id="title"> About Me </div>
<div class="artikel">
  <p>Hello, my name is Gabriel who made this website, I'm an ordinary person who just wants to know the world about Everything but actually I'm lazy to do things like that.
if you want to know about my social media just click the link <a href="https://rosydr.carrd.co" target="_blank"> <i class="fa fa-external-link" aria-hidden="true"></i> Overhere
</a></p>
  <p>This website is not my only project. If you wanna see my another sites you can click the link below <i class="fa fa-angle-down" aria-hidden="true"></i>
</p>
  <p>Jiwa Laknat Sites <br><a href="https://jiwalaknatsites.000webhostapp.com" target="_blank"><i class="fa fa-external-link" aria-hidden="true"></i> Click Here
</a></p>Gabrier Index<p><a href="https://media.gabriersite.workers.dev" target="_blank"><i class="fa fa-external-link" aria-hidden="true"></i> Click Here
</a></p>
<div class="picture">
<img src="https://i.ibb.co/RHmtJ9k/hayah.png" id="pic" alt="adad" border="0"></div>
<div class="back"><a href="login" class="back"><b><i class="fa fa-angle-double-left"></i>  Login Page</b></a></div><br>
</div>
<div class="footer">&#169; <script type='text/javascript'>var creditsyear = new Date();document.write(creditsyear.getFullYear());</script> Gabrier Media All Rights Reserved<br><div id="creator"><p>Created by Gabriel</p></div></div>
</div></body>", content_type="text/html")
